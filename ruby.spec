...
Requires:       readline ncurses gdbm db4 glibc openssl zlib
BuildRequires:  readline-devel ncurses-devel gdbm-devel db4-devel glibc-devel gcc openssl-devel make zlib-devel patch
